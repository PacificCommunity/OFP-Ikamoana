...
- `<effort_file>` (*Optional*) : Default value is `forcing_dir`+`run_name`+`"_effort.nc"`. This is the filepath to the effort dataset. It help to reduce the computation time of the mortality.
